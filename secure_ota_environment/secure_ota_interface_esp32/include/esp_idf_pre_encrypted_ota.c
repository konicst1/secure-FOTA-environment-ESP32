...
extern const char rsa_private_pem_start[] asm("_binary_private_esp_pre_encryption_key_pem_start");
extern const char rsa_private_pem_end[]   asm("_binary_private_esp_pre_encryption_key_pem_end");
